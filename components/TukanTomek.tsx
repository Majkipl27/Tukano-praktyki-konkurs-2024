...
export default function TukanTomek() {
  return (
    <div className="flex flex-col items-end 2xl:w-2/3 w-full gap-16 my-16">
      <Image src={Tukan_Tomek} alt="" width={192} height={218} />
      <div className="w-full min-h-20 px-4 py-2 bg-amber-800 border-4 border-orange-700 rounded-lg relative">
